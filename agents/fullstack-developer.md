...
dont_use_when:
  - situation: "you want a read-only security or OWASP review of existing code"
    alternative: code-security-reviewer
  - situation: "you want to run the lint/typecheck/test gate without writing feature code"
