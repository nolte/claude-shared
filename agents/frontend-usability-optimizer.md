...
dont_use_when:
  - situation: "you want to build a new feature, route, endpoint, schema, or business logic"
    alternative: fullstack-developer
  - situation: "you want a read-only deep audit that only reports findings without editing code"
