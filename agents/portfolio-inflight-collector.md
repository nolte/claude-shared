...
The agent returns a single in-flight collection report. One entry per in-scope Portfolio-Member repository, structured by data source, plus an aggregated overview at the top.
