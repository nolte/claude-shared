...
target: "plugins/nolte-engineering/skills/kpi-derive/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: kpi-derive

## Scope

Target: `plugins/nolte-engineering/skills/kpi-derive/` (full review; frontmatter, body, and every referenced supporting file).
