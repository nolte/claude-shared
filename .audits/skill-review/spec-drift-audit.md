...
target: "skills/spec-drift-audit/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: spec-drift-audit

## Scope

Target: `skills/spec-drift-audit/` (full review; frontmatter, body, and every referenced supporting file).
...
- [x] [skill-review.references] templates/audit.template.md is 110 lines without a ToC.
      Resolution: Contents block added (fixed in this batch).
