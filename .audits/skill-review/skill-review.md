...
target: "plugins/nolte-claude-dev/skills/skill-review/SKILL.md"
target-kind: skill
specs-applied:
...
Target: `plugins/nolte-claude-dev/skills/skill-review/` (full review; frontmatter, body, and every referenced supporting file).
