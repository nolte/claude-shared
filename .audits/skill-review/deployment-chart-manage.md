...
target: "plugins/nolte-engineering/skills/deployment-chart-manage/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: deployment-chart-manage

## Scope

Target: `plugins/nolte-engineering/skills/deployment-chart-manage/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.gotchas] No Gotchas section for the Helm/bjw-s environment (mitigated by delegation).
      → deferred: add a short Gotchas section on next edit.
