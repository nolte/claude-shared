...
target: "skills/feature-decompose/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: feature-decompose

## Scope

Target: `skills/feature-decompose/` (full review; frontmatter, body, and every referenced supporting file).
...
- [x] [skill-review.standing-instructions] Change-log phrasing anchored to one-time transitions (two passages).
      Resolution: both restated as timeless facts (fixed in this batch).
