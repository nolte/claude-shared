...
target: "skills/yaml-json-schema/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: yaml-json-schema

## Scope

Target: `skills/yaml-json-schema/` (full review; frontmatter, body, and every referenced supporting file).
