...
target: "plugins/nolte-claude-dev/skills/skill-management/SKILL.md"
target-kind: skill
specs-applied:
...
Target: `plugins/nolte-claude-dev/skills/skill-management/` (full review; frontmatter, body, and every referenced supporting file).
