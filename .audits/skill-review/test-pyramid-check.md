...
target: "plugins/nolte-engineering/skills/test-pyramid-check/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: test-pyramid-check

## Scope

Target: `plugins/nolte-engineering/skills/test-pyramid-check/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.gotchas] No Gotchas for consumer-stack tier-mapping variance.
