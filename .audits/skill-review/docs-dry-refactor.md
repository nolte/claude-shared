...
Target: `skills/docs-dry-refactor/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.body-size] Body at the cap boundary (validator: approaching).
      → deferred: externalise Hard-rules detail before the next addition.

- [ ] [skill-review.duplicate] DRY audit surface overlaps mkdocs-structure-apply; chain acknowledged in Output contract.
