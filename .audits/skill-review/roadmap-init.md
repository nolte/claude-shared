...
target: "skills/roadmap-init/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: roadmap-init

## Scope

Target: `skills/roadmap-init/` (full review; frontmatter, body, and every referenced supporting file).
