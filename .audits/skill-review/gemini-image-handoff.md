...
target: "plugins/nolte-media/skills/gemini-image-handoff/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: gemini-image-handoff

## Scope

Target: `plugins/nolte-media/skills/gemini-image-handoff/` (full review; frontmatter, body, and every referenced supporting file).
...
- [x] [skill-review.language] Unattributed German contract phrase in the EN body.
      Resolution: glossed as the original requirement's wording with the English contract name leading (fixed in this batch).
