...
target: "skills/mission-revise/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: mission-revise

## Scope

Target: `skills/mission-revise/` (full review; frontmatter, body, and every referenced supporting file).
