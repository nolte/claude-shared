...
target: "skills/permission-allowlist-maintain/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: permission-allowlist-maintain

## Scope

Target: `skills/permission-allowlist-maintain/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.standing-instructions] Old-patterns section accumulates dated quarterly records inside the always-loaded body.
      → deferred: cap at most recent record on next quarterly run.
