...
Target: `skills/mkdocs-structure-apply/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.body-size] Body sits at the ~5,000-token cap (validator: approaching); compaction risk.
      → deferred: move the site_url-derivation and five-extension-cap gotchas into references/operations.md on next edit.
