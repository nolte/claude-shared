...
target: "skills/roadmap-plan/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: roadmap-plan

## Scope

Target: `skills/roadmap-plan/` (full review; frontmatter, body, and every referenced supporting file).
