...
target: "skills/requirements-elicit/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: requirements-elicit

## Scope

Target: `skills/requirements-elicit/` (full review; frontmatter, body, and every referenced supporting file).
