...
target: "plugins/nolte-engineering/skills/quality-gate/SKILL.md"
target-kind: skill
specs-applied:
...
Target: `plugins/nolte-engineering/skills/quality-gate/` (full review; frontmatter, body, and every referenced supporting file).
...
- [x] [skill-review.frontmatter] Description mixed verb forms (imperative fragments).
      Resolution: changed to third-person 'tabulates … calls out' (fixed in this batch).
