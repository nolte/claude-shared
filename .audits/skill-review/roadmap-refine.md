...
target: "skills/roadmap-refine/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: roadmap-refine

## Scope

Target: `skills/roadmap-refine/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.frontmatter] dont_use_when entries 1 and 2 semantically overlap.
      → deferred: collapse into one entry on next frontmatter edit.
