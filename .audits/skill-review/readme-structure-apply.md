...
target: "skills/readme-structure-apply/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: readme-structure-apply

## Scope

Target: `skills/readme-structure-apply/` (full review; frontmatter, body, and every referenced supporting file).
