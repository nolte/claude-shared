...
target: "plugins/nolte-engineering/skills/source-code-review/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: source-code-review

## Scope

Target: `plugins/nolte-engineering/skills/source-code-review/` (full review; frontmatter, body, and every referenced supporting file).
