...
target: "plugins/nolte-engineering/skills/api-documentation-audit/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: api-documentation-audit

## Scope

Target: `plugins/nolte-engineering/skills/api-documentation-audit/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.evaluation] No examples/ scenarios (siblings ship three).
