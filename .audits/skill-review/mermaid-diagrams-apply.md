...
target: "skills/mermaid-diagrams-apply/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: mermaid-diagrams-apply

## Scope

Target: `skills/mermaid-diagrams-apply/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.duplicate] Operation 4 carries an inline duplicate of mermaid-diagram-reviewer's audit as an acknowledged fallback.
