...
target: "plugins/nolte-engineering/skills/api-error-check/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: api-error-check

## Scope

Target: `plugins/nolte-engineering/skills/api-error-check/` (full review; frontmatter, body, and every referenced supporting file).
