...
target: "skills/continuous-improvement-triage/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: continuous-improvement-triage

## Scope

Target: `skills/continuous-improvement-triage/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.duplicate] Catalog-lookup machinery restated in issue-orchestrate (shared spec §Portfolio gap closure); entry points delimited.
