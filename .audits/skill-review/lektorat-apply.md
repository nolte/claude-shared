...
target: "skills/lektorat-apply/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: lektorat-apply

## Scope

Target: `skills/lektorat-apply/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.body-size] Body near the cap (validator: approaching).
      → deferred: move longer Gotchas entries into references/operations.md before the next edit.
