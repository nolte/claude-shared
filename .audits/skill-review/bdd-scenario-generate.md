...
target: "plugins/nolte-engineering/skills/bdd-scenario-generate/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: bdd-scenario-generate

## Scope

Target: `plugins/nolte-engineering/skills/bdd-scenario-generate/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.evaluation] No examples/ scenarios despite the ten-step workflow.
      → deferred: add three walkthroughs in a follow-up authoring pass.
