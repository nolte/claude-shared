...
target: "skills/cookiecutter-template-manage/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: cookiecutter-template-manage

## Scope

Target: `skills/cookiecutter-template-manage/` (full review; frontmatter, body, and every referenced supporting file).
...
- [x] [skill-review.paths] Hard-coded user-specific absolute path in examples/02.
      Resolution: replaced with <repo-root> placeholder (fixed in this batch).

- [x] [skill-review.references] examples/02 and examples/03 exceed 100 lines without a ToC.
      Resolution: Contents blocks added to both (fixed in this batch).
