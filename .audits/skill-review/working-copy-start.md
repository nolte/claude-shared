...
target: "skills/working-copy-start/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: working-copy-start

## Scope

Target: `skills/working-copy-start/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-vs-agent.rationale] Rationale names three decisive dimensions but no counter-dimension.
      → deferred: add one considered counter-dimension bullet on next edit.
