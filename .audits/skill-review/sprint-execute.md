...
target: "skills/sprint-execute/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: sprint-execute

## Scope

Target: `skills/sprint-execute/` (full review; frontmatter, body, and every referenced supporting file).
