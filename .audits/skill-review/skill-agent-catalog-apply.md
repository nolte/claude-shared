...
target: "plugins/nolte-claude-dev/skills/skill-agent-catalog-apply/SKILL.md"
target-kind: skill
specs-applied:
...
Target: `plugins/nolte-claude-dev/skills/skill-agent-catalog-apply/` (full review; frontmatter, body, and every referenced supporting file).
...
- [x] [skill-review.standing-instructions] Body contradicted itself on spec availability (no-installed-copy vs via-plugin fallback).
      Resolution: precondition 4 aligned with the unavailable-spec rule; plugin-fallback clause dropped (fixed in this batch).
