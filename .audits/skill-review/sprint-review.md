...
target: "skills/sprint-review/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: sprint-review

## Scope

Target: `skills/sprint-review/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.body-size] Body near the cap (validator basis; <70 tokens headroom by reviewer estimate).
      → deferred: move the per-kind validation table into references/ before adding anything.
