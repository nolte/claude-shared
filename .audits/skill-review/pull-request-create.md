...
Target: `skills/pull-request-create/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.body-size] Reviewer estimated over-cap; authoritative validator measured 4,974 (approaching, not over) — downgraded per §Scope note.
      → deferred: extract the audit-remediation block or Gotchas into references/ on the next substantive edit.
