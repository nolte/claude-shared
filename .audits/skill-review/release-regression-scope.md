...
target: "plugins/nolte-engineering/skills/release-regression-scope/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: release-regression-scope

## Scope

Target: `plugins/nolte-engineering/skills/release-regression-scope/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.language] German spec-quoted terms appear verbatim in the EN body (zielgenau/zeitnah); spec-anchored identifiers, not a violation.
