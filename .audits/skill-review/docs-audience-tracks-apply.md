...
target: "skills/docs-audience-tracks-apply/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: docs-audience-tracks-apply

## Scope

Target: `skills/docs-audience-tracks-apply/` (full review; frontmatter, body, and every referenced supporting file).
