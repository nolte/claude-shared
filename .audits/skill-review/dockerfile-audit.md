...
target: "plugins/nolte-engineering/skills/dockerfile-audit/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: dockerfile-audit

## Scope

Target: `plugins/nolte-engineering/skills/dockerfile-audit/` (full review; frontmatter, body, and every referenced supporting file).
...
- [ ] [skill-review.body-size] GHCR severity rationale duplicated between body and Gotchas; near-cap headroom.
      → deferred: deduplicate on next edit.
