...
target: "plugins/nolte-claude-dev/skills/agent-review/SKILL.md"
target-kind: skill
specs-applied:
...
Target: `plugins/nolte-claude-dev/skills/agent-review/` (full review; frontmatter, body, and every referenced supporting file).
...
- [x] [skill-review.duplicate] 'Review all agents' loop rule left the bulk trigger ambiguous against skills-agents-sweep.
      Resolution: rule now routes the consolidated cross-cutting report to skills-agents-sweep; the loop yields per-artefact plans only (fixed in this batch).
