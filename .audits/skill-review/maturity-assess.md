...
target: "plugins/nolte-engineering/skills/maturity-assess/SKILL.md"
target-kind: skill
specs-applied:
...
# Skill Review: maturity-assess

## Scope

Target: `plugins/nolte-engineering/skills/maturity-assess/` (full review; frontmatter, body, and every referenced supporting file).
...
- [x] [skill-review.duplicate] Axis-B grading overlapped source-code-review's D2–D4 with no mutual delimitation (sweep boundary-matrix finding).
      Resolution: bidirectional dont_use_when clauses added on both sides (fixed in this batch).
