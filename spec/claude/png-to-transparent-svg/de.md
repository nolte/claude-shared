...
- Soll die Reinigungs-Erkennungs-Schwelle (welcher RGB-Delta gilt als „matcht die Fake-Transparenz-Farbe") pro Invocation konfigurierbar sein oder auf die KI-Generator-Outputs eingestellt bleiben, die den Agent motiviert haben?
- Muss die Spec aufzählen, welche KI-Generatoren beobachtet wurden, dieses Fake-Transparenz-Muster zu produzieren, sodass künftiges Detektor-Tuning eine Baseline hat?
- Wenn der Detektor unsicher ist (gemischte Eckpixel-Farben, teilweise Alpha bereits vorhanden), soll der Agent den Aufrufer fragen oder per Default auf Skip-Cleanup-und-Durchreichen zurückfallen?
