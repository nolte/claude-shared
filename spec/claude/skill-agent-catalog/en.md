...
- **MUST NOT** include skills or agents that do not conform to the `skill-management` / `agent-management` structure; malformed entries **MUST** fail the docs build rather than be silently omitted
