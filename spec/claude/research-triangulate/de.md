...
- **DARF NICHT [MUST NOT]** repo-interne Aussagen separat triangulieren — die werden durch direktes Lesen der Working Copy verifiziert; Triangulation gegen externe Quellen wäre langsamer und unzuverlässiger als ein `Grep`
