...
Die Gemini-Billing-Aussagen in §Kontext und §`gemini` sind Author-Time-externe Aussagen, trianguliert gemäß `spec/claude/research-triangulate/` §"Author-time assertions" (Author-Time-Stufe: mindestens drei unabhängige Quellen, Primary-first geordnet). Sie verdienen die strengere Behandlung, weil eine frühere Revision dieser Fähigkeit auf der umgekehrten Prämisse aufgebaut war. Abrufdatum für jede Quelle unten: 2026-07-24.
