...
- [ ] Double fidelity is required portfolio-wide (a double never more permissive than what it replaces along a relied-on dimension), the exemption requires both that the double can't be made faithful there and that the divergence is declared, and per-tier expression is delegated to the tier specs
