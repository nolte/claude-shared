...
- **MUSS [MUST]** jeder Stufen-Spec erlauben, diese Regel für ihre eigene Doubling-Praxis auszuprägen — die Nähte, die sie doubelt, und die dort am häufigsten weggelassenen Constraints —, ohne sie zu wiederholen, gemäß dem Feld *Isolationsgrad & erlaubte Test-Doubles* der invarianten Stufen-Form.
