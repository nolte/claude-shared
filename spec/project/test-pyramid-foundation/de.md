...
- [ ] Der Abschnitt zu abgeleiteten Artefakten deklariert die Entwickeln/Ausführen/Analysieren-Triade und benennt die bestehenden E2E-Artefakte als ihre Vorlage
...
- Wenn die eingebettete Subsektion §„Test-tier completeness (the pyramid)" der e2e-Spec auf eine Referenz zu diesem Fundament reduziert wird, richtet sich `test-pyramid-check` auf diese Spec neu aus oder bleibt nur für die E2E-Stufen-Disziplin auf die e2e-Spec gerichtet?
