...
- [ ] Real-vs-Flake-Disziplin ist gefordert: echt vermuten, kein Wegerklären ohne Evidenz, und ein einzelner grüner Re-Run klärt einen Fehlschlag nicht, zitiert auf Google
...
- Wie viele unabhängige Re-Runs (und über welches Fenster) sollte die Phase verlangen, bevor sie einen Fehlschlag als Flake versus echt klassifiziert — eine feste Zahl oder eine Konfidenzschwelle?
