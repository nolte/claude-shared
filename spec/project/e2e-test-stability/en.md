...
- The direction of Selenium `is_displayed` for an element clipped by a scrollable ancestor (campaign mode 6) is unconfirmed against the WebDriver element-displayedness algorithm; some sources report the opposite of the observed value
