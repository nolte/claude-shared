...
GitHub-gehostete Runner führen Jobs aus einem Kontingent gleichzeitiger Jobs pro GitHub-Plan aus (Free 20, Pro 40, Team 60, Enterprise 500 Standard-Jobs zum Zeitpunkt des Schreibens [R13]), und aus diesem Kontingent schöpfen alle Repositories des Accounts zugleich: Ein in einem Repository wartender Job wartet auf einen Slot, den ein Job eines anderen Repositories hält. In diesem Portfolio am 2026-09-19 gemessen, warteten `needs:`-freie Jobs von 16–68 Sekunden 10–24 Minuten auf einen Runner, während ihr eigenes Repository nichts ausführte, und zwei Drittel aller Jobs endeten unter einer Minute und trugen dabei 7 % der Arbeit (`nolte/claude-shared#644`). Auf dieser Plattform ist ein Job, nicht eine Sekunde Laufzeit, die Einheit der knappen Ressource, und die Behebung „nebenläufig ausführen" aus `continuous-integration` §B ist nicht kostenlos.
