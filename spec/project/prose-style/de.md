...
- [ ] Keine englisch-gescopte Prosa trägt generische geschlechts-gebundene Pronomen (`he`, `she`, `his`, `hers`, `he/she`), militaristische oder ableistische Ersetzungen, die die Microsoft-Bias-Free-Communication-Tabelle ratifiziert, Ausrufezeichen außerhalb echter Betonung oder kulturell spezifische Idiome; `.vale.ini` führt die Microsoft-Regeln `Gender`, `GenderBias` und `BiasFree` auf `error`-Stufe aus, sodass jeder Verstoß, den diese Regeln kennen, das Gate scheitern lässt
