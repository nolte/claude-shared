...
- Recursion anchors (auditable per the §Acceptance Criteria recursion check): this spec is itself authored under the [`spec` skill](../../../skills/spec/SKILL.md) and follows the six-section template at [`skills/spec/templates/spec.template.md`](../../../skills/spec/templates/spec.template.md).
