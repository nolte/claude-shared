...
- Vorschreiben eines einzigen Artefakt-Formats für jeden Kontext. Der kanonische Default für einen eigenständigen bounded context ist `AUDIENCES.md` an dessen Wurzel (siehe das Artefakt-Speicher-SHOULD in den Anforderungen), aber kleine oder Sub-Modul-Kontexte **DÜRFEN** die Liste in einen README-Abschnitt oder einen ADR einbetten; diese Spec ratifiziert den Default, verbietet die Alternativen aber nicht
