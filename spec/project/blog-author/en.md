...
_The handover-contract-as-YAML-schema and hero-image-corpus-policy deferrals were settled on 2026-06-06 (decision log preserved in git history): the prose handover contract stands, and the hero-image corpus policy stays a consumer-side product decision. The resolved item above and the Intentionally-not-open notes below are retained._
