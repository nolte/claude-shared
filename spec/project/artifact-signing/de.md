...
- **KANN** in einem privaten Repository ohne GitHub Enterprise Cloud, in dem der Attestierungsmechanismus der Plattform nicht verfügbar ist, die SLSA-v1-Provenance stattdessen als Cosign-Attestation des gepushten Digests veröffentlichen (`cosign attest --type slsaprovenance1`); die Anforderungen an Signatur und SBOM oben bleiben unverändert
