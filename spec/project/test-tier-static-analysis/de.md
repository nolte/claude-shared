...
- Braucht die Entwickeln/Ausführen/Analysieren-Triade dieser Stufe einen dedizierten Analyse-Agent, oder genügt der bestehende `quality-gate`-Skill (Ausführen) plus der `quality-gate-enforcer`-Agent (Wiring-Audit), mit nur einer dünnen „Static-Analysis-Stufen-Autor"-Capability als Ergänzung?
