...
- [ ] A provider state is forbidden from arranging data the real provider would reject, the spec states why provider verification can't catch it, and the tier's delimitation against the portfolio-wide double-fidelity rule is explicit
