...
- Release cadence, sprint rituals, or project-management practices—this spec is event-driven (audit outcome) and calendar-driven (quarterly review), not sprint-driven
