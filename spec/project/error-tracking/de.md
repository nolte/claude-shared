...
Alle fünf ursprünglichen offenen Fragen wurden am 2026-07-25 vom Operator entschieden; die Entscheidungs-Records bleiben hier zur Nachvollziehbarkeit stehen. Der einzige tatsächlich offene Rest ist die konkrete Form der Audit-Fähigkeit.
...
- **Künftige `error-tracking-audit`-Fähigkeit (eingeplant 2026-07-25, Form offen).** Verfolgt als `nolte/claude-shared#516`, autorisiert nachdem das kamerplanter-Dogfooding einen realen Adopter zur Kalibrierung der Checks geliefert hat. Das konkrete Check-Set und das Report-Format bleiben der eine offene Punkt und werden beim Autorieren festgelegt.
