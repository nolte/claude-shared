...
- [ ] The foundation's fidelity rule is applied to the doubled neighbours by reference rather than restated, and delimited against the in-memory-fake ban that governs the one real seam
