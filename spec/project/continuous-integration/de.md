...
- **MUSS** die Teststufe über das deklarierte Taskfile-Target des Repositories aufrufen, statt den Aufruf inline nachzubauen, gemäß der Paritätsregel in `spec/project/taskfile/` §Parität von lokalem Lauf und CI
