...
Readers: authors identifying the audiences of a project's release notes, the `release-notes-curate` skill authors who shape the body against that set, and reviewers checking the notes serve upgraders, packagers, security teams, and automated consumers.
