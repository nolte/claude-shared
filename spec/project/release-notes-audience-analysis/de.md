...
Leser: Autoren, die die Zielgruppen der Release-Notes eines Projekts identifizieren, die Autoren des `release-notes-curate`-Skills, die den Body gegen dieses Set formen, sowie Reviewer, die prüfen, dass die Notes Upgrader, Packager, Security-Teams und automatisierte Konsumenten bedienen.
