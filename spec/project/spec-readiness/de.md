...
## Offene Fragen
- Default: spec-readiness bleibt ein beratendes, von der Betreiberin durchgesetztes Gate — es ist nicht in CI verdrahtet. Erneut erwägen, wenn: mindestens vier abgeschlossene Quartals-Audits unter `.audits/spec-readiness/YYYY-Q<n>.md` existieren (vollständige Audits, keine Rahmen-Eröffnungen — heute ist nur 2026-Q2 ein abgeschlossenes Audit; die 2026-Q3-Datei ist ein Mid-Q2-Rahmen, dessen vollständiger Lauf für Juli–Sept 2026 geplant ist) UND über diese Audits hinweg die gemessene Falsch-Critical-Rate (später verzichtete oder re-klassifizierte Criticals ÷ insgesamt erhobene Criticals) unter 10% liegt, UND mindestens ein Einzel-Spec-Beförderungslauf ein `review-plan`-Format-Artefakt erzeugt hat, das AK Zeile 102 erfüllt und damit belegt, dass das maschinen-parsebare Format stabil ist. Bis beide Bedingungen gelten, würde ein CI-Gate PRs an heuristischen, urteilsbehafteten Critical-Befunden blockieren, die der Agent selbst als menschliche Auflösung erfordernd kennzeichnet.
