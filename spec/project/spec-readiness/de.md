...
- **MUSS** verifizieren, dass jedes Akzeptanzkriterium dasselbe aussagt wie die Anforderung, auf die es zurückführt — ein AK, das enger oder weiter ist oder eine Ausnahme trägt, die die Anforderung nicht kennt, ist `Warning`, der Befund der **veralteten Wiederholung**. Er unterscheidet sich vom verwaisten Fall darüber: Das AK führt sehr wohl auf eine Anforderung zurück, es sagt nur etwas anderes aus als sie. Genau das entsteht, wenn jemand eine Anforderung ändert, ohne durchzugehen, was sie wiederholt, und es zählt, weil ein Konsument, der Akzeptanzkriterien als Schranke behandelt, die aufgegebene Fassung umsetzt. Anders als die Widerspruchsprüfungen aus §Dimension 1 braucht er auf der AK-Seite kein RFC-2119-Verb, denn verglichen wird die Zuordnung, nicht die Verbstärke
...
- [ ] Kein Akzeptanzkriterium einer auditierten Spec sagt eine Regel aus, die seine eigene Anforderung nicht aussagt; wo doch, hat das Audit es als `Warning` wegen veralteter Wiederholung festgehalten, statt die Spec durchzuwinken
