...
_The token-bundle-registry, CMYK, and imagery-style hand-off deferrals were settled on 2026-06-06 (see `.audits/decisions/2026-06-06-settle-open-questions.md`); the `brand-primary` OKLCH question above stays open as a pending brand-owner decision._
