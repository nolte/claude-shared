...
_Die Deferrals zu Token-Bundle-Registry, CMYK und imagery-style-Übergabe wurden am 2026-06-06 entschieden (siehe `.audits/decisions/2026-06-06-settle-open-questions.md`); die `brand-primary`-OKLCH-Frage oben bleibt offen als ausstehende Brand-Owner-Entscheidung._
