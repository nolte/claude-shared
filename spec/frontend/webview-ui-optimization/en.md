...
- Whether `palette.contrastThreshold` behaves identically under the MUI v9 `colorSchemes` + `cssVariables` API (and whether v9 tightens dark-mode contrast defaults) is unverified; re-check before enforcing the 4.5 threshold as a hard audit gate.
