...
two diagonal eye-stripes, jagged head tuft, coral cheeks, three cream claws per limb.
...
a stylised chibi cartoon sloth plush-toy seen from a THREE-QUARTER BACK angle, from behind and slightly to the left. Mostly we see its rounded deep blue-indigo back and the back of its round head with the small jagged tuft; the back itself is solid deep blue-indigo with NO central cream patch — only a thin sliver of the cream face-mask edge shows on the far side where the face turns away. Deep blue-indigo fur (desaturated blue-violet, NOT brown). Short arms at the sides, three pale cream claws per limb. Bold dark-indigo outline, the character resting flat on the ground with a soft-grey oval shadow touching its base. Rear three-quarter view, face mostly hidden.
...
phrase right after "facing the viewer, fully symmetrical." (front) and adjust as needed.
...
or asymmetric face (front view); **on back / rear views: no cream or pale patch on the
