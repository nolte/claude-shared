...
- Chibi cartoon **three-toed sloth**, sitting upright, facing the viewer, symmetrical.
...
- **The cream is ONLY on the face mask. The whole body — chest, belly, back and
  sides — is solid indigo with NO belly patch.** The only other pale areas are the claws.
...
- Style: modern flat-design kawaii vector cartoon, matte fills, generous negative
  ...
  in dark mode). Eyes near-black-brown `#3A2A22`, cheeks coral-orange `#E8825A`.
...
## Pose variants (append after "symmetrical" in the Light prompt)
...
body is solid indigo (no belly patch); face cream only. Also avoid: embedded text,
other companies' logos, watermark, photorealism, 3D/gradients, a raised single eyebrow
or asymmetric face, extra limbs or claws beyond three, teal-cyan / pure-red / neon.
