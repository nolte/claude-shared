...
tags: [requirements]
phase: plan
summary: "Runs the requirements-elicitation interview and produces an authoritative requirement artifact gated by a confidence/gap-matrix KPI."
summary_de: "Führt das Anforderungserfassungs-Interview und erzeugt ein autoritatives Anforderungs-Artefakt, gegated durch eine Confidence-/Lücken-Matrix-KPI."
use_when:
...
dont_use_when:
  - situation: "You already have a requirement set and want to break it into features"
    alternative: feature-decompose
  - situation: "You want to author the downstream specification document"
    alternative: spec
see_also:
  - feature-decompose
  - roadmap-plan
