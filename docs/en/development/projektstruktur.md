...
| Spec index | `spec/README.md` (auto-generated — do not hand-edit) |
...
The plugin is called `nolte-shared` (see `.claude-plugin/plugin.json`). Skills are invocable as `/nolte-shared:<skill>`. The plugin name is not changed lightly — it is part of every invocation and every document.
