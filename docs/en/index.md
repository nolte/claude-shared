...
!!! info "What this repo is *not*"
    It is not an end-user app, not a framework, and not a replacement for Claude Code. It is a **collection of shared configuration** that plugs into Claude Code.
