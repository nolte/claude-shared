...
> Reviews existing integration tests against the integration-tier spec, returns a checklist-based conformance verdict, and applies only minimal surgical fixes.
...
- **Source:** [agents/integration-test-reviewer.md](https://github.com/nolte/claude-shared/blob/main/agents/integration-test-reviewer.md)
