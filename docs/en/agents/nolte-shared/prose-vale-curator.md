...
> Curates prose to pass Vale, prefers shipped vocabularies, extends accept.txt only inside vocabulary-owning repos.
...
- **Distribution:** `plugin`
- **Tags:** `prose`, `audit`
- **Source:** [agents/prose-vale-curator.md](https://github.com/nolte/claude-shared/blob/main/agents/prose-vale-curator.md)
...
- **You want a six-dimension editorial review (readability, audience-fit) rather than Vale-clean rephrasing** → [`lektorat-apply`](../../skills/nolte-shared/lektorat-apply.md)
