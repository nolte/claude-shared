...
> Scaffolds spec-conformant narrow integration tests (one real ephemeral collaborator, the rest doubled, seam-only assertions, per-test isolation, readiness waits, TC-IDs).
...
- **Source:** [agents/integration-test-generator.md](https://github.com/nolte/claude-shared/blob/main/agents/integration-test-generator.md)
