...
> Autonomously works off a lektorat audit report by routing each artefact to the matching author and re-auditing until it converges.
...
- **Tags:** `prose`, `audit`
- **Source:** [skills/lektorat-auto-revise/SKILL.md](https://github.com/nolte/claude-shared/blob/main/skills/lektorat-auto-revise/SKILL.md)
