...
> Triages a failing GitHub Actions workflow on develop/main and dispatches the most specialised agent to remediate.
...
- **Source:** [skills/workflow-health-triage/SKILL.md](https://github.com/nolte/claude-shared/blob/main/skills/workflow-health-triage/SKILL.md)
