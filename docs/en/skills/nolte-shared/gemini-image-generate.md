...
> Generates an image from a text prompt via the Gemini Free-Tier model, writing the image plus a metadata sidecar to a chosen path.
...
- **Phase:** 4 Build (`build`)
- **Tags:** `design`
- **Source:** [skills/gemini-image-generate/SKILL.md](https://github.com/nolte/claude-shared/blob/main/skills/gemini-image-generate/SKILL.md)
