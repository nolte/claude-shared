...
- **You want to choose or change the project's own outbound license** → [`project-structure-apply`](project-structure-apply.md)
...
This skill follows the hybrid pattern: the read-only inventory phase is delegated to the [`license-check-scanner`](../../agents/nolte-shared/license-check-scanner.md) agent (context-window isolation, tool restriction), while the policy gate and follow-up actions stay in the skill.
