...
> Authors a project's first project/mission.md via the SMART walk and the four required body sections.
...
- **Tags:** `scaffolding`
- **Source:** [skills/mission-define/SKILL.md](https://github.com/nolte/claude-shared/blob/main/skills/mission-define/SKILL.md)
