...
> Creates a spec-conformant worktree, fills its plan-before-work stub, and hands off to a fresh resumable session.
...
- **Phase:** 2 Plan (`plan`)
- **Tags:** `scaffolding`
- **Source:** [skills/working-copy-start/SKILL.md](https://github.com/nolte/claude-shared/blob/main/skills/working-copy-start/SKILL.md)
