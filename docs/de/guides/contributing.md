...
2. **Skill/Agent anlegen** — nutze den [Skill-Management](../skills/nolte-claude-dev/skill-management.md)-Skill. Er legt ASCII-Kebab-Case-Ordner an, schreibt valides Frontmatter und verhindert typische Fehler.
