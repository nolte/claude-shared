...
> Nur-Lese-Roadmap-Kohärenz-Audit gegen Goals, Mission, Sprints und Features; strukturierte Findings-Liste.
...
- **Distribution:** `plugin`
- **Tags:** `review`, `audit`
- **Quelle:** [agents/roadmap-coherence-reviewer.md](https://github.com/nolte/claude-shared/blob/main/agents/roadmap-coherence-reviewer.md)
