...
> Erfasst oder aktualisiert den tech_stack-Block in project/portfolio.yml durch Sondieren von Lockfiles, Taskfile, CI und Tooling-Configs.
...
- **Tags:** `scaffolding`
- **Quelle:** [skills/tech-stack-capture/SKILL.md](https://github.com/nolte/claude-shared/blob/main/skills/tech-stack-capture/SKILL.md)
