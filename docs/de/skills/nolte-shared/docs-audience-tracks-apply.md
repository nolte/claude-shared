...
> Verdrahtet Per-Page-Track-Frontmatter und Audience-zu-Track-Mapping in MkDocs docs/; Audit-, Migrate- oder Patch-Operationen.
...
- **Quelle:** [skills/docs-audience-tracks-apply/SKILL.md](https://github.com/nolte/claude-shared/blob/main/skills/docs-audience-tracks-apply/SKILL.md)
