...
- **Orchestration role**: this skill dispatches the [`lektorat-scanner`](../../agents/nolte-shared/lektorat-scanner.md) agent for the read-only D1–D6 detection (context-window protection, tool restriction) and stays in the main thread to render results, run operator dialogues, and write outputs.
