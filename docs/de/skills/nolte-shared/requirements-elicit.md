...
> Führt das Anforderungserfassungs-Interview und erzeugt ein autoritatives Anforderungs-Artefakt, gegated durch eine Confidence-/Lücken-Matrix-KPI.
...
- **Phase:** 2 Plan (`plan`)
- **Tags:** `requirements`
- **Quelle:** [skills/requirements-elicit/SKILL.md](https://github.com/nolte/claude-shared/blob/main/skills/requirements-elicit/SKILL.md)
