...
> Führt die Audience-Identifikation gegen einen abgegrenzten Kontext aus und erzeugt ein autoritatives Audience-Artefakt.
...
- **Phase:** 2 Plan (`plan`)
- **Tags:** `audience`
- **Quelle:** [skills/audience-identify/SKILL.md](https://github.com/nolte/claude-shared/blob/main/skills/audience-identify/SKILL.md)
