...
> Erzeugt aus einem Projekt eine schema-valide Backstage-catalog-info.yaml: inferiert per-Kind-MUST-Floor-Felder aus Repo-Signalen, klärt den Rest mit dem Operator und validiert selbst.
...
- **Phase:** 4 Build (`build`)
- **Tags:** `scaffolding`
- **Quelle:** [skills/backstage-catalog-generate/SKILL.md](https://github.com/nolte/claude-shared/blob/main/skills/backstage-catalog-generate/SKILL.md)
