...
> Prüft die Stufen-Vollständigkeit gegen die test-pyramid-foundation-Taxonomie (Unit/Component/Integration/Contract/E2E) und E2E-Disziplin gegen e2e-test-automation; liefert einen Lückenbericht.
...
- **Quelle:** [skills/test-pyramid-check/SKILL.md](https://github.com/nolte/claude-shared/blob/main/skills/test-pyramid-check/SKILL.md)
...
- **you want to scaffold a new E2E suite** → [`e2e-test-generator`](../../agents/nolte-engineering/e2e-test-generator.md)
- **you want to run the lint/typecheck/test gate** → [`quality-gate`](quality-gate.md)

## Siehe auch

- [`e2e-test-generator`](../../agents/nolte-engineering/e2e-test-generator.md)
- [`e2e-test-reviewer`](../../agents/nolte-engineering/e2e-test-reviewer.md)
- [`quality-gate`](quality-gate.md)

## Referenziert von

- [`component-test-reviewer`](../../agents/nolte-engineering/component-test-reviewer.md)
- [`contract-test-reviewer`](../../agents/nolte-engineering/contract-test-reviewer.md)
- [`e2e-test-reviewer`](../../agents/nolte-engineering/e2e-test-reviewer.md)
- [`integration-test-reviewer`](../../agents/nolte-engineering/integration-test-reviewer.md)
- [`unit-test-reviewer`](../../agents/nolte-engineering/unit-test-reviewer.md)
...
If an E2E tier exists for `$ARGUMENTS`, check it against the spec's disciplines (grep-level, not a deep code review — that is [`e2e-test-reviewer`](../../agents/nolte-engineering/e2e-test-reviewer.md)):
...
Flag violations by file; for a deep per-line review or repairs, hand off to [`e2e-test-reviewer`](../../agents/nolte-engineering/e2e-test-reviewer.md).
...
1. Read and report only — never scaffold, edit, or run tests. Scaffolding is [`e2e-test-generator`](../../agents/nolte-engineering/e2e-test-generator.md); repair is [`e2e-test-reviewer`](../../agents/nolte-engineering/e2e-test-reviewer.md); running the gate is [`quality-gate`](quality-gate.md).
...
4. Keep the E2E check at grep/structure level; route deep review and fixes to [`e2e-test-reviewer`](../../agents/nolte-engineering/e2e-test-reviewer.md).
