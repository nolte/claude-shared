...
- `plugins/nolte-planning/skills/roadmap-init/SKILL.md` — the skill under review, now containing the user's fixes

## Expected behaviour

1. Read `.audits/skill-review/roadmap-init.md`, locate items 1 and 3, and re-run the specific check that produced each finding by re-reading `plugins/nolte-planning/skills/roadmap-init/SKILL.md` (and re-grepping for the duplicate-prevention case) — never take the user's word alone when verification is cheap.
