...
2. Compose the deletion commit message exactly: subject `chore(agent-review): close release-notes-drafter—3C/1W/2S/1I`, body listing the two deferred issue URLs and the plan's recorded `repo-revision` SHA; no hook bypass, no signing skip, English-only.
